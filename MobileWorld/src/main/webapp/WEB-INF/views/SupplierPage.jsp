...
<div class="container" ng-app="repeatSample">
	<c:choose>
		<c:when test="${check}">
			<div class="row">
				<form:form class="form-horizontal" method="post" action="addsup"
					commandName="Supplier" >
					<fieldset>

						<!-- Form Name -->
						<legend>Supplier1</legend>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="requestName">Supplier
								Id</label>
							<div class="col-md-4">
								<form:input class="form-control input-md" path="sid"
									readonly="false" value="${sid+1}"></form:input>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="comments">Supplier
								Address</label>
							<div class="col-md-4">
								<form:textarea class="form-control" path="saddress" />
							</div>
						</div>
	...
	<div ng-controller="repeatController">
		<div>
			search:<input type="text" placeholder="search supplier"
				ng-model="searchsup" /> <br>
			<br>
