...
<body>
  <div class="page-header">
               <h2 style="color:black;"><center>MOBILES WORLD</center></h2>
             </div>
            </div>
...
<div class="row">
	...
	<div class="col-md-12">
	   <p><img src="D:\mobilephotos\about us.png" width=1000 height=360 class="pull-center"></p>
 	      <div class="col-md-12"><p> In February 2010, Kunal Bahl along with Rohit Bansal, started Snapdeal.com - India's largest online marketplace, with the widest assortment of 30 million plus products across 800 plus diverse categories from over 125,000 regional, national, and international brands and retailers.
...
In its journey till now, Snapdeal has partnered with several global marquee investors and individuals such as SoftBank, BlackRock, Temasek, Foxconn, Alibaba, eBay Inc., Premji Invest, Intel Capital, Bessemer Venture Partners, Mr. Ratan Tata, among others.</p></div>
               </div>
	 </div>
</div>
