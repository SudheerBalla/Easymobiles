...
<body>
  <div class="page-header">
               <h2 style="color:ccccc;"><center>MOBILES WORLD</center></h2>
             </div>
            </div>
...
<div class="container">
    <div class="row">
	<div class="col-md-6">
	            <center><img src="D:\mobilephotos\iphone-7-concept-ciccarese.png" class="img-Thumbnail" alt="Cinque Terre"  width=200 height=260 ></center> 
                    <h2 style="color:red;"><center>EASY MOBILES</center></h2>

   	</div>	
           
	   <div class="col-md-6"> 
           <div class="jumbotron">
     								<span style="color:dark brown">SIGN UP:</span>
	  			<center>First name: <input type="text" name="firstname" autocomplete="on"></center><br>
     
				  <center>Last name :<input type="text" name="lastname" autocomplete="on"></center><br>
         			<center>   E mail: <input type="email" name="email" autocomplete="on"></center><br>
				<center>Password  : <input type="password" name="password" autocomplete="off"><br><br>
			     <div class="checkbox">
                                <label><input type="checkbox"> Remember me</label>
                             </div>
                                   <input type="submit" value="Submit"><nbr>
 				   <input type="reset"><br>
